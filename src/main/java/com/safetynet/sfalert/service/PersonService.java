...
public class PersonService {
  ...
  public HashMap<String, Object> getStationPeople(String stationNumber) throws ParseException{
    ...
    HashMap<String, Object> listAndCount = new HashMap<String, Object>();
    List<Integer> majorityCount = this.childAndAdultCount(this.legalAgeFonction(this.ageCalculator()));
    listAndCount.put("areaPeople", stationPeoples);
    listAndCount.put("adultNumberinArea", majorityCount.get(1));
    listAndCount.put("childNumberinArea", majorityCount.get(0));
    return listAndCount;
  }
